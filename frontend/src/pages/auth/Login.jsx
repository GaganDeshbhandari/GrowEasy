          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="relative pt-6 pb-2">
              ...
              <div className="relative flex justify-center">
                <span className="bg-[#FDFBF7] dark:bg-[#0A0F0D] px-4 text-xs font-bold uppercase tracking-widest text-gray-500">Or continue with</span>
              </div>
            </div>

            <button
              type="button"
              className="w-full bg-white dark:bg-[#111812] border-2 border-gray-200 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-[#1A241A] text-[#111812] dark:text-white font-bold py-3.5 px-6 rounded-xl transition-all duration-300 flex items-center justify-center gap-3 active:scale-[0.98]"
            >
