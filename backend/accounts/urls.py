...
urlpatterns = [
  ...
  path('farmer/bank-details/', FarmerBankDetailListCreateView.as_view(), name='farmer-bank-detail-list-create'),
  path('farmer/bank-details/<int:pk>/', FarmerBankDetailDetailView.as_view(), name='farmer-bank-detail-detail'),
  path('farmer/bank-details/<int:pk>/set-primary/', FarmerBankDetailSetPrimaryView.as_view(), name='farmer-bank-detail-set-primary'),
